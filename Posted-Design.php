  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0" class="nav nav-pills">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item active" href="Posted-Design.php">Posted Designs</a>
		  <div class="dropdown-divider"></div>
...
<div class="container">
	...
	<form action="Posted-Design.php" method="POST">
...
<div class="container">
    ...
    <div class="row row-cols-1 row-cols-md-3">
					...
					$query = $dbh->prepare("SELECT * FROM design WHERE ProductName LIKE '%%$keyword%%' OR ProductID LIKE '%$keyword%'  ORDER BY id DESC ");
					$query->execute();
				  ...
				  <div class="col mb-4">
					<div class="card h-100">
					  <img src="Uploads/disigns/<?php echo $row['Image']; ?>" class="card-img-top" alt="" height="250px" width="300px">
					  <div class="card-body">
						<h5 class="card-title"><b><?php echo $row['ProductName']; ?></b> Rs: <?php echo $row['Price']; ?></h5>
						<h6>Product Code: <?php echo $row['ProductID']; ?></h6>
							...
							<center>
								<a href="options/edit-design.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">Edit Details</a>  						
								<a href="options/delete-design.php?del=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure, you want to delete this product?');">Delete</a>
						</center>
					  </div>
					</div>
				  </div>
...
<div class="container">
    <div class="row row-cols-1 row-cols-md-3">
					...
					$query = $dbh->prepare("SELECT * FROM design ORDER BY id DESC ");
					$query->execute();
